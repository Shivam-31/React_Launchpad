...
// 🔥 Loader function - Username ke saath dynamic
...
function Github() {
    ...
    const handleSearch = (e) => {
        e.preventDefault()
        if (searchUser.trim()) {
            navigate(`/github/${searchUser.trim()}`)
        }
    }
            ...
            <div className="max-w-4xl mx-auto">
                ...
                <div className="mb-8">
                    <form onSubmit={handleSearch} className="flex gap-3 max-w-md mx-auto">
                        ...
                        <button
                            type="submit"
                            className="px-6 py-3 bg-orange-600 hover:bg-orange-700 rounded-lg font-semibold transition duration-200"
                        >
                            Search
                        </button>
                    </form>
                        ...
                        <div className="flex-grow text-center md:text-left">
                            ...
                            <div className="space-y-3">
                                ...
                                {loaderData.blog && (
                                    <div className="flex items-center justify-center md:justify-start text-gray-300">
                                        <svg className="w-5 h-5 mr-2" fill="currentColor" viewBox="0 0 20 20">
                                            <path fillRule="evenodd" d="M12.586 4.586a2 2 0 112.828 2.828l-3 3a2 2 0 00-2.828 0 1 1 0 00-1.414 1.414 4 4 0 005.656 0l3-3a4 4 0 00-5.656-5.656l-1.5 1.5a1 1 0 101.414 1.414l1.5-1.5zm-5 5a2 2 0 012.828 0 1 1 0 101.414-1.414 4 4 0 00-5.656 0l-3 3a4 4 0 105.656 5.656l1.5-1.5a1 1 0 10-1.414-1.414l-1.5 1.5a2 2 0 11-2.828-2.828l3-3z" clipRule="evenodd" />
                                        </svg>
                                ...
                                <div className="flex items-center justify-center md:justify-start text-gray-300">
                                    ...
                                    Joined {new Date(loaderData.created_at).toLocaleDateString('en-US', { 
                                        year: 'numeric', 
                                        month: 'long', 
                                        day: 'numeric' 
                                    })}
